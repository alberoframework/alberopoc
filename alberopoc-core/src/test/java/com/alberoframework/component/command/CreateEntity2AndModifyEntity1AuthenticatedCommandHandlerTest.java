...
import com.alberoframework.component.command.CommandHandlerPocTestStubs.CreateEntity2AndModifyEntity1AuthenticatedCommandHandler;
...
public class CreateEntity2AndModifyEntity1AuthenticatedCommandHandlerTest extends SimpleAuthenticatedCommandHandlerRepositoryTestSupport<CreateEntity2AndModifyEntity1AuthenticatedCommandHandler, CreateEntity2AndModifyEntity1Command, VoidUnit>{
	...
	public TestSpecification testSuccess() {
		return 	given(
						...
						.when(
								handle(
										command(new CreateEntity2AndModifyEntity1Command(2L, 3L, "prop2"),
										"userId")
								)
						 )
						.then(
