...
@Setter
@Component
public class SetIssueInProgressCommandHandler extends AbstractIssueTrackerVoidCommandHandler<SetIssueInProgressCommand> {

    @Autowired
    private IssueRepository issueRepository;

    @Override
    protected void doHandle(SetIssueInProgressCommand command, ContextualizedQueryGateway queryGateway, ContextualizedCommandGateway commandGateway) {
